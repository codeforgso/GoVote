    ...
    return (
      <Map className="map" center={position} zoom={11}>
        ...
        <Marker position={position}>
          <Popup>
            <span><a href="http://codeforgreensboro.org" target="_blank"><img className="logo" src="../static/CfGLogo.png" alt="CfG"/></a><h3>Hello!</h3><h4>I am <a href='http://govotegso.org' target='_blank'>GoVoteGSO</a><br/>Help <a href='http://codeforgreensboro.org' target='_blank'>Code for Greensboro</a> make me awesome!</h4></span>
          </Popup>
        </Marker>
