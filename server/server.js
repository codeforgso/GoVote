...
router.get('/api/:fn/:ln', async (req, res) => {
  ...
  // const query = `SELECT * FROM ${voterTable} INNER JOIN ${pollingTable} ON ${voterTable}.precinct_abbrv = ${pollingTable}.precinct_name WHERE voter_status_desc NOT LIKE 'REMOVED' and first_name ilike $1::text and last_name ilike $2::text`;
