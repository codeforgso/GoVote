...
const EarlyVoting = () => (
  <main>
    ...
    <h2>Official Information</h2>
      <p>
        <a 
          href="https://www.guilfordcountync.gov/our-county/board-of-elections/absentee-voting-information/early-voting-one-stop-voting" 
          rel="noopener noreferrer" 
          target="_blank">
          Official Early Voting information
        </a> 
        is available at the Guilford County Board of Elections website.
      </p>
    ...
    <h2>Schedule</h2>
      ...
      <p>
        <a 
          href="https://www.google.com/maps/d/viewer?mid=1gqVAS4N-hUOhVB-WqTBEiovUv9wPavlS&hl=en&ll=36.05232562242983%2C-79.8143897&z=11" 
          rel="noopener noreferrer" 
          target="_blank">
