...
```
$ docker-compose build # Builds the govote image
$ docker-compose exec govote node ./bin/create-tables.js # Creates tables
$ docker-compose exec govote node ./bin/etl.js # Pulls data from the NC Board of Elections site into the db.
$ docker-compose up -d # Starts the services. You can now access the project at http://localhost:3000
```
